...
<form class="form-horizontal" action="<?php echo base_url()."index.php/Order/do_update"; ?>" method="POST" enctype="multipart/form-data">
          <fieldset>
            <legend class="text-center">Masukkan Status Pesanan</legend>
    
            <!-- Name input-->
			 <div class="form-group">
              <label class="col-md-3 control-label" for="id">No. ID</label>
              <div class="col-md-9">
                <input id="id" name="id" type="text" class="form-control"  value="<?php echo $Id;?>" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="nama">Nama Pemesan</label>
              <div class="col-md-9">
                <input id="nama" name="nama" type="text" class="form-control" value="<?php echo $nama; ?>" readonly>
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="paket">Type Paket</label>
              <div class="col-md-9">
                <input id="paket" name="paket" type="text" class="form-control"  value="<?php echo $paket; ?>" readonly>
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="jumlah">Jumlah</label>
              <div class="col-md-9">
                <input id="jumlah" name="jumlah" type="text" class="form-control"  value="<?php echo $jumlah; ?>" readonly>
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="cp">Contact Person</label>
              <div class="col-md-9">
                <input id="paket" name="cp" type="text" class="form-control"  value="<?php echo $cp; ?>" readonly>
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="alamat">Alamat</label>
              <div class="col-md-9">
                <input id="alamat" name="alamat" type="text" class="form-control"  rows="5" value="<?php echo $alamat; ?>" readonly>
              </div>
            </div>
