...
<form class="form-horizontal" action="<?php echo base_url()."index.php/Imenu/d_upload"; ?>" method="post" enctype="multipart/form-data">
          <fieldset>
            <legend class="text-center">Masukkan Menu Baru</legend>
    
            <!-- Name input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="paket">Paket</label>
              <div class="col-md-9">
                <input id="paket" name="paket" type="text" class="form-control" placeholder="No. Paket" required="required" onkeypress="return isNumberKey(event)">
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="isi">Isi Paket</label>
              <div class="col-md-9">
                <textarea class="form-control" id="isi" name="isi" placeholder="Isi Paket tersebut" rows="5"  required="required"></textarea>
              </div>
            </div>
			<div class="form-group">
              <label class="col-md-3 control-label" for="harga">Harga</label>
              <div class="col-md-9">
                <input id="harga" name="harga" type="text" placeholder="Price" class="form-control" required="required" onkeypress="return isNumberKey(event)">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="upload">Gambar(320x150 px)</label>
              <div class="col-md-9">
